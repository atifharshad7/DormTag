...
export default function App() {
  ...
  return (
    <div className="app">
      ...
      <main className={
        // The operator's own screens carry the left panel and manage their own
        // width; everything else stays a centred column.
        kind === "operator" && screen === "main" ? "opview"
          : (kind === "operator" && screen !== "manage") || screen === "stickers" ? "wide"
          : "narrow"
      }>
        {route.kind === "reset" ? (
